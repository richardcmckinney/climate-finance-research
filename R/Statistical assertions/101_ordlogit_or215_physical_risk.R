...
# Manuscript assertion: "OR=2.15 for physical risk"
...
if (!requireNamespace("MASS", quietly=TRUE)) stop("MASS required"); ord_model_physical <- MASS::polr(factor(Q12.13_1) ~ Q3.3, data = data, Hess = TRUE); print(exp(coef(ord_model_physical)))
