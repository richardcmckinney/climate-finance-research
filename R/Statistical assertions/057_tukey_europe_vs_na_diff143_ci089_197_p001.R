# File: 057_tukey_europe_vs_na_diff143_ci089_197_p001.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "European regulatory risk ratings exceeded North American by 1.43 points (95% CI [0.89, 1.97], p<.001)"
...
geo_risk_data <- na.omit(data.frame(region = factor(data$Q2.2), reg_risk = suppressWarnings(as.numeric(data$Q3.6_3)))); aov_geo <- aov(reg_risk ~ region, data = geo_risk_data); print(TukeyHSD(aov_geo)$region["2-1", ])
