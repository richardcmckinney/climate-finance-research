# File: 102_ordlogit_or248_regulatory_risk.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "OR=2.48 for regulatory risk"
...
if (!requireNamespace("MASS", quietly=TRUE)) stop("MASS required"); ord_model_regulatory <- MASS::polr(factor(Q12.13_3) ~ Q3.3, data = data, Hess = TRUE); print(exp(coef(ord_model_regulatory)))
