...
# Manuscript assertion: "impact metrics & compliance automation (r=.253, p<.001)"
...
print(cor.test(suppressWarnings(as.numeric(data$Q12.1_14)), suppressWarnings(as.numeric(data$Q12.1_15))))
