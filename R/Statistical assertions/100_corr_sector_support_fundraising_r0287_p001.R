...
# Manuscript assertion: "correlation between receiving sector-specific support and fundraising success (r=.287, p<.001)"
...
sector_support <- as.numeric(grepl("10", data$Q3.10)); fundraising <- suppressWarnings(as.numeric(data$Q3.8_14)); print(cor.test(sector_support, fundraising))
