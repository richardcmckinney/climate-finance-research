...
# Manuscript assertion: "funding and regulatory support (r=.478, p<.001)"
...
funding <- as.numeric(grepl("5", data$Q3.10)); regulatory <- as.numeric(grepl("3", data$Q3.10)); print(cor.test(funding, regulatory))
