...
# Manuscript assertion: "Training and networking correlate (r=.449, p<.001)"
...
training <- as.numeric(grepl("4", data$Q3.10)); networking <- as.numeric(grepl("1", data$Q3.10)); print(cor.test(training, networking))
