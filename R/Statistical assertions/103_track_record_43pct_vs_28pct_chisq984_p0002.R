# File: 103_track_record_43pct_vs_28pct_chisq984_p0002.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "43% vs. 28% for financial-focused, χ²(1)=9.84, p=.002"
...
track_table <- matrix(c(43, 57, 28, 72), nrow = 2); print(chisq.test(track_table))
