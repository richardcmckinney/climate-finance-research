...
esg_data <- data[data$Q2.1 == "8", c("Q10.6_8","Q10.6_9","Q10.6_10","Q10.6_11","Q10.6_12")]; esg_cor_matrix <- cor(apply(esg_data, 2, function(x) suppressWarnings(as.numeric(x))), use="complete.obs"); cat("Mean r:", round(mean(esg_cor_matrix[lower.tri(esg_cor_matrix)]),3), "\n")
