...
# Manuscript assertion: "χ²(32)=98.7, p<.001, CFI=.94, TLI=.92, RMSEA=.069"
...
if (!requireNamespace("lavaan", quietly=TRUE)) stop("lavaan required"); model <- 'physical =~ Q12.13_1 + Q12.13_2
policy =~ Q12.13_3 + Q12.13_4
market =~ Q12.13_5 + Q12.13_6'; fit <- lavaan::cfa(model, data = data); print(lavaan::fitMeasures(fit, c("chisq","df","pvalue","cfi","tli","rmsea")))
