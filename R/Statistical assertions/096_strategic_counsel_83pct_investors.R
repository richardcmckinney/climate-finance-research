...
# Manuscript assertion: "Strategic counsel (83%)"
...
investors <- subset(data, Q2.1 %in% c("1","2","7","8")); strategic <- sum(grepl("3", investors$Q3.10), na.rm = TRUE); investor_total <- sum(!is.na(investors$Q3.10)); strategic_pct <- (strategic / investor_total) * 100; cat("Strategic counsel %:", round(strategic_pct,2), "\n")
