...
# Manuscript assertion: "real-time data & AI risk assessment (r=.236, p<.001)"
...
print(cor.test(suppressWarnings(as.numeric(data$Q12.1_12)), suppressWarnings(as.numeric(data$Q12.1_13))))
