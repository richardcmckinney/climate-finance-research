# File: 075_factor2_policy_regulatory_eig291_var208pct.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "Factor 2: Policy-Regulatory (Eigenvalue: 2.91, 20.8% variance)"
