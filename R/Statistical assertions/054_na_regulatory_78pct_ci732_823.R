...
na_data <- subset(data, Q2.2 == "1"); na_reg <- sum(grepl("regulatory", na_data$Q3.11, ignore.case = TRUE), na.rm = TRUE); na_total <- sum(!is.na(na_data$Q3.11)); print(prop.test(na_reg, na_total, conf.level = 0.95))
