...
# Manuscript assertion: "mentorship and strategic partnerships (r=.374, p<.001)"
...
mentorship <- as.numeric(grepl("2", data$Q3.10)); partnerships <- suppressWarnings(as.numeric(data$Q3.8_6)); print(cor.test(mentorship, partnerships))
