# File: 108_power_chisq_082_w03.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "achieved statistical power reached 0.82 for medium effect magnitude (w=0.3)"
...
if (!requireNamespace("pwr", quietly=TRUE)) stop("pwr required"); print(pwr::pwr.chisq.test(w = 0.3, N = 113 + 1194, df = 1, sig.level = 0.05))
