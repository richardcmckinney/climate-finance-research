...
# Manuscript assertion: "Networking (94%)"
...
investors <- subset(data, Q2.1 %in% c("1","2","7","8")); networking <- sum(grepl("1", investors$Q3.10), na.rm = TRUE); investor_total <- sum(!is.na(investors$Q3.10)); networking_pct <- (networking / investor_total) * 100; cat("Networking %:", round(networking_pct,2), "\n")
