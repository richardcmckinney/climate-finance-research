...
# Manuscript assertion: "Policy-Regulatory risks for VCs (β=-.42, p<.001)"
...
vc_policy_model <- lm(Q3.8_8 ~ Q12.13_3 + Q12.13_4, data = subset(data, Q2.1 == "1")); print(summary(vc_policy_model))
