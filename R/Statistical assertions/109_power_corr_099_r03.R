# File: 109_power_corr_099_r03.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "statistical power exceeding 0.99 for medium effect detection (r=0.3)"
...
if (!requireNamespace("pwr", quietly=TRUE)) stop("pwr required"); print(pwr::pwr.r.test(n = 857, r = 0.3, sig.level = 0.05))
