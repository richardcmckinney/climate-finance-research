...
# Manuscript assertion: "Surveying 1,307 stakeholders"
...
n_complete <- sum(data$Status == "IP Address" & suppressWarnings(as.numeric(data$Progress)) >= 10, na.rm = TRUE)
cat("Total respondents:", n_complete, "\n")
