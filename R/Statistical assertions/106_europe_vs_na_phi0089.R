# File: 106_europe_vs_na_phi0089.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "European vs. North American, φ=.089"
...
geo_reg_table <- matrix(c(359, 59, 347, 98), nrow = 2); if (!requireNamespace("vcd", quietly=TRUE)) {{ print(chisq.test(geo_reg_table)) }} else {{ print(vcd::assocstats(geo_reg_table)) }}
