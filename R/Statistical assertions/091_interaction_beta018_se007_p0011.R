...
# Manuscript assertion: "β=0.18, SE=0.07, p=.011"
...
interaction_model <- lm(investment ~ market_readiness * regulatory_barriers, data = data.frame(investment = suppressWarnings(as.numeric(data$Q3.8_8)), market_readiness = suppressWarnings(as.numeric(data$Q3.6_2)), regulatory_barriers = suppressWarnings(as.numeric(data$Q3.6_3)))); print(summary(interaction_model))
