...
# Manuscript assertion: "Market-Financial risks for government (β=-.38, p<.001)"
...
gov_market_model <- lm(Q4.6_7 ~ Q12.13_5 + Q12.13_6, data = subset(data, Q2.1 == "2")); print(summary(gov_market_model))
