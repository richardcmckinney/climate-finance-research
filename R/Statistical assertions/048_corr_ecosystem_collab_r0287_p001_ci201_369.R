...
ecosystem_support <- suppressWarnings(as.numeric(data$Q3.10)); collab_preference <- suppressWarnings(as.numeric(data$Q3.8_10)); print(cor.test(ecosystem_support, collab_preference))
