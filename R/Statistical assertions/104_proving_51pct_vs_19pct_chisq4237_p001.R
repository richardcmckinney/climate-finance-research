# File: 104_proving_51pct_vs_19pct_chisq4237_p001.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "51% vs. 19% for financial-focused, χ²(1)=42.37, p<.001"
...
proving_table <- matrix(c(51, 49, 19, 81), nrow = 2); print(chisq.test(proving_table))
