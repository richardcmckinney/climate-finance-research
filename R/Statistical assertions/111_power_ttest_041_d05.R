# File: 111_power_ttest_041_d05.R
# Purpose: Replicate the manuscript statistical test or descriptive statistic for this specific assertion.
# Manuscript assertion: "achieved statistical power of merely 0.41 for medium effect detection"
...
if (!requireNamespace("pwr", quietly=TRUE)) stop("pwr required"); print(pwr::pwr.t.test(n = 16, d = 0.5, sig.level = 0.05, type = "two.sample"))
